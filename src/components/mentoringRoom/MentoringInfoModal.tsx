...
const MentoringInfoModal = () => {
	...
	return (
		<>
			...
			<button
				className="absolute top-10 right-0 bg-sky-500 hover:bg-sky-700 text-white py-2 px-4 rounded-full z-10 shadow-lg "
				onClick={onClickOpenModal}
			>
			...
			{isModalOpen && (
				<div className="fixed inset-0 flex items-center justify-center z-20 ">
					...
					<div className="z-10 bg-white p-8 rounded-lg ">
						<div className="flex justify-between items-center mt-20 w-[15rem] lg:w-[30rem]">
